                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('usuario') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="id_cliente" type="text" class="form-control" name="id_cliente" value="{{ old('usuario') }}">
                        ...
                        <div class="form-group{{ $errors->has('genero') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="genero" type="radio" class="form-control" name="genero" value="1">Hombre<br>
                                <input id="genero" type="radio" class="form-control" name="genero" value="2">Mujer
                        ...
                        <div class="form-group{{ $errors->has('calleynum') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="calleynum" type="text" class="form-control" name="calleynum" value="{{ old('calleynum') }}">
