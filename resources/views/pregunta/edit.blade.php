...
<html>
    ...
    <body>
        <nav class="navbar navbar-default navbar-fixed-top">
            ...
            {{ Form::open(['route' => ['pregunta.update', $pregunta->id_pregunta],  'method' => 'PUT']) }}
                    ...
                    <input value="{{ $pregunta -> pregunta }}" name="pregunta" id="pregunta" required type="text" placeholder="Titulo"/><br>
